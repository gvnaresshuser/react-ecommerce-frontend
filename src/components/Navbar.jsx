...
import { Key, X, Settings, LogOut, ShoppingCart } from "lucide-react";
...
export default function Navbar() {
    ...
    return (
        <div className="flex justify-between bg-black text-white p-4">
            ...
            <div className="flex items-center gap-4">
                ...
                {isAuth &&
                    <Link to="/products" className={isActive("/")}>Products</Link>
                }
                ...
                {isAuth && (
                    <>
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center p-2 bg-orange-400 rounded hover:bg-gray-600"
                        >
                            <Key size={18} />
                        </button>
  ...
  flex items-center gap-1 whitespace-nowrap w-auto hover:bg-green-600 transition ${isActive("/admin")}`}
                >
                    <Settings size={16} />
                    <span>Admin</span>
                </Link>
